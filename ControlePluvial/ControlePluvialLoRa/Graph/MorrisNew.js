/* @license
 ...
 Modified by damiancardona.
 Additional credits to JelteF who did all the job, I simply translate it to js
 */
...
(function () {
                    ...
                    _results.push((function () {
                        ...
                        for (sidx = _k = 0, _len1 = _ref2.length; _k < _len1; sidx = ++_k) {
                            ...
                            if (ypos !== null) {
                                ...
                                if (this.options.inBarValue) {
                                    var barMiddle = left + barWidth / 2;
                                    var fontSize = barWidth / 2;

                                    /* Condi��o especial para o gr�fico "Colaboradores com mais registros no m�s" */
                                    if (_ref2.length == 4)
                                        fontSize = 12;

                                    /* Limita o tamanho m�ximo da fonte em 20 */
                                    if (fontSize > 20) {
                                        fontSize = 20;
                                        this.options.inBarValueRightMargin = size + 15;
                                    }
                                    else 
                                        this.options.inBarValueRightMargin = size + 10;

                                    this.raphael.text(barMiddle, bottom - this.options.inBarValueRightMargin, this.yLabelFormat(row.y[sidx], sidx))
                                      .attr('font-size', fontSize)
                                      .attr('font-family', this.options.gridTextFamily)
                                      .attr('font-weight', this.options.gridTextWeight)
                                      .attr('fill', this.options.inBarValueTextColor)
    ...
    Morris.Donut = (function (_super) {
        ...
        Donut.prototype.setLabels = function (label1, label2) {
            ...
            this.text2.attr({
                text: label2 + (this.options.percentage?'%':''),
                transform: ''
            });
